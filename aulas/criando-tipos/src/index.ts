...
function addSSatellite(name: string, planet: Planet) {
...
function thirdMenuOption() {
  promptValidPlanet((planet) => {
    ...
    addSSatellite(satellite, planet);
  });
}
